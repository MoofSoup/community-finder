...
class BamlSyncClient:
    ...
    def GenerateCytoscapeGraph(
      ...
      return cast(types.CytoscapeJSON, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def GenerateCytoscapeGraph(
        ...
        input: Union[str, baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.CytoscapeJSON, types.CytoscapeJSON]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[partial_types.CytoscapeJSON, types.CytoscapeJSON](
        raw,
        lambda x: cast(partial_types.CytoscapeJSON, x.cast_to(types, partial_types)),
        lambda x: cast(types.CytoscapeJSON, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
